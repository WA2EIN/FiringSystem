...
Public Class TestCaseForm
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs)
        ...
        For i = 0 To DataGridView1.Rows.Count - 1
            ...
            For j = 0 To Units(UnitIndex).NumberOfPorts - 1
                Units(UnitIndex).Ports(j) = New PortsClass()

                Units(UnitIndex).Ports(j).Port.Active = True
                If (Units(UnitIndex).PinStatus.Substring(j, 1)) = "0" Then
    ...
    Private Sub TestCaseForm_Load(sender As System.Object, e As System.EventArgs)
