...
RAM char                  CRLF[3]               ="\r\n";
RAM char                  Starting[]            = "Starting V2    02/07/22";
    ...
    */
    ...
    while (TRUE)
    {
        ...
        if (RecResult > 0)
        {
			...
			//    WDT is set when USART interrupt generated.  It is used to insure a hardware malfunction
			//    does not tie up the USART.
            ...
            if ( Ccode != Ccode2)
            {
				...
				// This should never occur.  It is a check to insure received data is generated by Firing System components and
				//	not an imposter.
        ...
        if ((RecResult > 0)|| (TEventActive == 1))
        {
            ...
            /********************************** Process the Broadcast Messages in this section if in Timed Show mode.**********************************/
