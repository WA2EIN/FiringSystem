...
Public Class CommClass
    ...
    Private ComPortName As String = "COM13"
    ...
    Public Function ReadVarString() As Integer
        ...
        If TimerStarted Then MainForm.Timer1.Enabled = False
        ...
        While (True)
            Try
                ...
                If Message.Substring(3, 3) = "001" Then
                    Message = "<==" & Message
                    'Traceit("<==" & Message)
                Else
                    Message = "==>" & Message
